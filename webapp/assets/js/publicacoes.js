...
function curtirPublicacao(evento){
  ...
  $.ajax({
    ...
    method: "POST",
      ...
      const quantidadeDeCurtidadas = parseInt(contadorDeCurtidas.text());

      contadorDeCurtidas.text(quantidadeDeCurtidadas + 1);
...
function atualizarPublicacao() {
     ...
     $.ajax({
      ...
      conteudo: $('#conteudo').val()
        ...
        Swal.fire("Sucesso!","Publicaçao criada com sucesso!", "success")
             .then (function(){
                window.location = "/home";
             })
 }).fail(function() {
...
function deletarPublicacao(evento) {
  ...
  Swal.fire({
    title: "Atenção!",
    text: "Tem certeza que deseja excluir ? Essa ação é irreversivel",
